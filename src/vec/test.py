...
if __name__ == "__main__":
    ...
    v3 *= 5
    print(f"Vector V3 after IMUL : ",v3)

    v4 += v3

    print(f"Vector V4 after IADD : ", v4)

    print(f"Zero Vector : ",Vec.zeros(5))
    print(f"Ones Vector : ", Vec.ones(5))
    print(f"Uniform Vector :", Vec.uniform(5))
    print(f"Normalisation Vector :", v4.norm())
    # v_test = Vec((5,6))
